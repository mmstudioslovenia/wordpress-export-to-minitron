...
class WPMT_Public {
	...
	public function enqueue_scripts() {
        ...
        wp_enqueue_style( 'wpmt-public-style',WPMT_URL . 'assets/public/css/wpmt.css', array(), WP_Mailerlite::get_version(), $media = 'all' );

        wp_enqueue_script( 'wpmt-public-js', WPMT_URL.'assets/public/js/wpmt.js', array('jquery'), WP_Mailerlite::get_version(), true );
